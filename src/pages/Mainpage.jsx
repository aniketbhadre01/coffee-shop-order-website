            ...
            <div className="flex flex-row flex-wrap justify-center gap-12 mt-20">
              {Array("", "", "").map((item, idx) => (
                ...
                >
                  ...
                  />
                  <h3 className="text-lg font-medium">Coffee Cad</h3>
                  <ul className="flex flex-col gap-5 mb-8 md:mb-20">
                    <li className="flex items-center gap-4">
                      <img src={checkIcon} alt="" /> Mixed Cad
                    </li>
                    <li className="flex items-center gap-4">
                      <img src={checkIcon} alt="" /> Coconut Cad
                    </li>
                    <li className="flex items-center gap-4">
                      <img src={checkIcon} alt="" /> Ice / Hot
                    </li>
                    <li className="flex items-center gap-4">
                      <img src={checkIcon} alt="" /> Oreo Cad
                    </li>
                  </ul>
                  ...
                  >
                    <div className="flex flex-row gap-2 items-center">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-primary text-sm">Parbhani, maharashtra</p>
                      </div>
