            ...
            <div className="flex flex-col gap-4 md:max-w-[50%]">
              <Link to="/">
                <div className="font-extrabold flex flex-row gap-2">
                  ...
                  <h1 className="text-xl text-black">Coffee Lounge </h1>
                </div>
              </Link>
              <div className="">
              Coffee Lounge is a store that sells some good meals, and especially
                coffee. We provide high quality beans in parbhani 
              </div>
              ...
              <div className="copyright">(c) Coffee Lounge-2024</div>
            </div>
